...
#define CACHE_L1_ICACHE0_PRELOAD_CTRL_REG   (DR_REG_CACHE_BASE + 0x0ac)
#define CACHE_L1_ICACHE0_PRELOAD_DONE       BIT(1)

#define CACHE_L1_ICACHE1_PRELOAD_CTRL_REG   (DR_REG_CACHE_BASE + 0x0b8)
#define CACHE_L1_ICACHE1_PRELOAD_DONE       BIT(1)

#define CACHE_L1_DCACHE_PRELOAD_CTRL_REG    (DR_REG_CACHE_BASE + 0x0dc)
