 ...
 *
 * @param spi_num SPI peripheral number (typically 1 for flash)
 * @param mode Read mode (SLOWRD, FASTRD, etc.)
 * @param cmd Command opcode
 * @param cmd_bit_len Command length in bits
 * @param addr Address value
 * @param addr_bit_len Address length in bits (32 for 4-byte addressing)
 * @param dummy_bits Number of dummy clock cycles
 * @param mosi_data Data to send (write operations)
 * @param mosi_bit_len Length of data to send in bits
 * @param miso_data Buffer to receive data (read operations)
 * @param miso_bit_len Length of data to receive in bits
 * @param cs_mask Chip select mask (ESP_ROM_OPIFLASH_SEL_CS0 or CS1)
 * @param is_write_erase_operation True for write/erase, false for read
 */
