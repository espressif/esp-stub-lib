...
__attribute__((weak)) int stub_target_nand_read_spare(uint32_t page_number, uint8_t *spare_data)
{
    (void)page_number;
    (void)spare_data;
    return -1;
...
__attribute__((weak)) int stub_target_nand_write_spare(uint32_t page_number, uint8_t is_bad)
{
    (void)page_number;
    (void)is_bad;
    return -1;
...
__attribute__((weak)) const uint8_t *stub_target_nand_get_debug_id(void)
{
    return s_debug_id;
}

__attribute__((weak)) const uint8_t *stub_target_nand_get_debug_extra(void)
{
