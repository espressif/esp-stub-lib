...
extern esp_rom_spiflash_result_t SPI_write_enable(struct esp_rom_spiflash_chip *flash_chip);
...
void __attribute__((weak)) stub_target_opiflash_exec_cmd(int spi_num, spi_flash_mode_t mode,
