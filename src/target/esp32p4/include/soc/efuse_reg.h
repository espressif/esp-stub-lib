...
/** EFUSE_DOWNLOAD_MODE_XPD_ON : RO; bitpos: [16]; default: 0;
 * Set this bit to power on XPD in download mode
 */
#define EFUSE_DOWNLOAD_MODE_XPD_ON    (BIT(16))
#define EFUSE_DOWNLOAD_MODE_XPD_ON_M  (EFUSE_DOWNLOAD_MODE_XPD_ON_V << EFUSE_DOWNLOAD_MODE_XPD_ON_S)
#define EFUSE_DOWNLOAD_MODE_XPD_ON_V  0x00000001U
#define EFUSE_DOWNLOAD_MODE_XPD_ON_S  16
...
/** EFUSE_DOWNLOAD_MODE_XPD_ON_ERR : RO; bitpos: [16]; default: 0;
 *  Represents the programming error of EFUSE_DOWNLOAD_MODE_XPD_ON
 */
#define EFUSE_DOWNLOAD_MODE_XPD_ON_ERR    (BIT(16))
#define EFUSE_DOWNLOAD_MODE_XPD_ON_ERR_M  (EFUSE_DOWNLOAD_MODE_XPD_ON_ERR_V << EFUSE_DOWNLOAD_MODE_XPD_ON_ERR_S)
#define EFUSE_DOWNLOAD_MODE_XPD_ON_ERR_V  0x00000001U
#define EFUSE_DOWNLOAD_MODE_XPD_ON_ERR_S  16
