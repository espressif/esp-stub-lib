...
/** HP_REG_VER_DATE : R/W; bitpos: [31:0]; default: 539296519;
 *  NA
 */
#define HP_SYSTEM_REG_VER_DATE    0xFFFFFFFFU
#define HP_SYSTEM_REG_VER_DATE_M  (HP_REG_VER_DATE_V << HP_REG_VER_DATE_S)
...
#define HP_SYSTEM_REG_CLK_EN_M  (HP_REG_CLK_EN_V << HP_REG_CLK_EN_S)
...
#define HP_SYSTEM_CPU_INT_FROM_CPU_0_M  (HP_CPU_INT_FROM_CPU_0_V << HP_CPU_INT_FROM_CPU_0_S)
...
#define HP_SYSTEM_CPU_INT_FROM_CPU_1_M  (HP_CPU_INT_FROM_CPU_1_V << HP_CPU_INT_FROM_CPU_1_S)
...
#define HP_SYSTEM_CPU_INT_FROM_CPU_2_M  (HP_CPU_INT_FROM_CPU_2_V << HP_CPU_INT_FROM_CPU_2_S)
...
#define HP_SYSTEM_CPU_INT_FROM_CPU_3_M  (HP_CPU_INT_FROM_CPU_3_V << HP_CPU_INT_FROM_CPU_3_S)
...
#define HP_SYSTEM_REG_L2_CACHE_CLK_ON_M  (HP_REG_L2_CACHE_CLK_ON_V << HP_REG_L2_CACHE_CLK_ON_S)
...
#define HP_SYSTEM_REG_L1_D_CACHE_CLK_ON_M  (HP_REG_L1_D_CACHE_CLK_ON_V << HP_REG_L1_D_CACHE_CLK_ON_S)
...
#define HP_SYSTEM_REG_L1_I1_CACHE_CLK_ON_M  (HP_REG_L1_I1_CACHE_CLK_ON_V << HP_REG_L1_I1_CACHE_CLK_ON_S)
...
#define HP_SYSTEM_REG_L1_I0_CACHE_CLK_ON_M  (HP_REG_L1_I0_CACHE_CLK_ON_V << HP_REG_L1_I0_CACHE_CLK_ON_S)
...
#define HP_SYSTEM_REG_L1_D_CACHE_RESET_M  (HP_REG_L1_D_CACHE_RESET_V << HP_REG_L1_D_CACHE_RESET_S)
...
#define HP_SYSTEM_REG_L1_I1_CACHE_RESET_M  (HP_REG_L1_I1_CACHE_RESET_V << HP_REG_L1_I1_CACHE_RESET_S)
...
#define HP_SYSTEM_REG_L1_I0_CACHE_RESET_M  (HP_REG_L1_I0_CACHE_RESET_V << HP_REG_L1_I0_CACHE_RESET_S)
 ...
 *  NA
 */
#define HP_SYSTEM_SYS_DMA_ADDR_CTRL_REG (DR_REG_HP_SYS_BASE + 0x2c)
...
#define HP_SYSTEM_REG_SYS_DMA_ADDR_SEL_M  (HP_REG_SYS_DMA_ADDR_SEL_V << HP_REG_SYS_DMA_ADDR_SEL_S)
...
#define HP_SYSTEM_REG_TCM_RAM_IBUS0_WT_M  (HP_REG_TCM_RAM_IBUS0_WT_V << HP_REG_TCM_RAM_IBUS0_WT_S)
...
#define HP_SYSTEM_REG_TCM_RAM_IBUS1_WT_M  (HP_REG_TCM_RAM_IBUS1_WT_V << HP_REG_TCM_RAM_IBUS1_WT_S)
...
#define HP_SYSTEM_REG_TCM_RAM_IBUS2_WT_M  (HP_REG_TCM_RAM_IBUS2_WT_V << HP_REG_TCM_RAM_IBUS2_WT_S)
...
#define HP_SYSTEM_REG_TCM_RAM_IBUS3_WT_M  (HP_REG_TCM_RAM_IBUS3_WT_V << HP_REG_TCM_RAM_IBUS3_WT_S)
...
#define HP_SYSTEM_REG_TCM_RAM_DBUS0_WT_M  (HP_REG_TCM_RAM_DBUS0_WT_V << HP_REG_TCM_RAM_DBUS0_WT_S)
...
#define HP_SYSTEM_REG_TCM_RAM_DBUS1_WT_M  (HP_REG_TCM_RAM_DBUS1_WT_V << HP_REG_TCM_RAM_DBUS1_WT_S)
...
#define HP_SYSTEM_REG_TCM_RAM_DBUS2_WT_M  (HP_REG_TCM_RAM_DBUS2_WT_V << HP_REG_TCM_RAM_DBUS2_WT_S)
...
#define HP_SYSTEM_REG_TCM_RAM_DBUS3_WT_M  (HP_REG_TCM_RAM_DBUS3_WT_V << HP_REG_TCM_RAM_DBUS3_WT_S)
...
#define HP_SYSTEM_REG_TCM_RAM_DMA_WT_M  (HP_REG_TCM_RAM_DMA_WT_V << HP_REG_TCM_RAM_DMA_WT_S)
...
#define HP_SYSTEM_REG_TCM_RAM_WRR_HIGH_M  (HP_REG_TCM_RAM_WRR_HIGH_V << HP_REG_TCM_RAM_WRR_HIGH_S)
...
#define HP_SYSTEM_REG_TCM_SW_PARITY_BWE_MASK_CTRL_M  (HP_REG_TCM_SW_PARITY_BWE_MASK_CTRL_V << HP_REG_TCM_SW_PARITY_BWE_MASK_CTRL_S)
 ...
 */
#define HP_SYSTEM_REG_HP_TCM_CLK_FORCE_ON    (BIT(0))
#define HP_SYSTEM_REG_HP_TCM_CLK_FORCE_ON_M  (HP_REG_HP_TCM_CLK_FORCE_ON_V << HP_REG_HP_TCM_CLK_FORCE_ON_S)
#define HP_SYSTEM_REG_HP_TCM_CLK_FORCE_ON_V  0x00000001U
#define HP_SYSTEM_REG_HP_TCM_CLK_FORCE_ON_S  0
...
#define HP_SYSTEM_REG_L2_ROM_CLK_FORCE_ON_M  (HP_REG_L2_ROM_CLK_FORCE_ON_V << HP_REG_L2_ROM_CLK_FORCE_ON_S)
...
#define HP_SYSTEM_REG_PROBE_A_MOD_SEL_M  (HP_REG_PROBE_A_MOD_SEL_V << HP_REG_PROBE_A_MOD_SEL_S)
...
#define HP_SYSTEM_REG_PROBE_A_TOP_SEL_M  (HP_REG_PROBE_A_TOP_SEL_V << HP_REG_PROBE_A_TOP_SEL_S)
...
#define HP_SYSTEM_REG_PROBE_L_SEL_M  (HP_REG_PROBE_L_SEL_V << HP_REG_PROBE_L_SEL_S)
...
#define HP_SYSTEM_REG_PROBE_H_SEL_M  (HP_REG_PROBE_H_SEL_V << HP_REG_PROBE_H_SEL_S)
...
#define HP_SYSTEM_REG_PROBE_GLOBAL_EN_M  (HP_REG_PROBE_GLOBAL_EN_V << HP_REG_PROBE_GLOBAL_EN_S)
...
#define HP_SYSTEM_REG_PROBE_B_MOD_SEL_M  (HP_REG_PROBE_B_MOD_SEL_V << HP_REG_PROBE_B_MOD_SEL_S)
...
#define HP_SYSTEM_REG_PROBE_B_TOP_SEL_M  (HP_REG_PROBE_B_TOP_SEL_V << HP_REG_PROBE_B_TOP_SEL_S)
...
#define HP_SYSTEM_REG_PROBE_B_EN_M  (HP_REG_PROBE_B_EN_V << HP_REG_PROBE_B_EN_S)
...
#define HP_SYSTEM_REG_PROBE_TOP_OUT_M  (HP_REG_PROBE_TOP_OUT_V << HP_REG_PROBE_TOP_OUT_S)
...
#define HP_SYSTEM_REG_L2_MEM_CLK_FORCE_ON_M  (HP_REG_L2_MEM_CLK_FORCE_ON_V << HP_REG_L2_MEM_CLK_FORCE_ON_S)
...
#define HP_SYSTEM_REG_CORE0_CORESTALLED_ST_M  (HP_REG_CORE0_CORESTALLED_ST_V << HP_REG_CORE0_CORESTALLED_ST_S)
...
#define HP_SYSTEM_REG_CORE1_CORESTALLED_ST_M  (HP_REG_CORE1_CORESTALLED_ST_V << HP_REG_CORE1_CORESTALLED_ST_S)
...
#define HP_SYSTEM_REG_ENABLE_SPI_MANUAL_ENCRYPT_M  (HP_REG_ENABLE_SPI_MANUAL_ENCRYPT_V << HP_REG_ENABLE_SPI_MANUAL_ENCRYPT_S)
...
#define HP_SYSTEM_REG_ENABLE_DOWNLOAD_DB_ENCRYPT_M  (HP_REG_ENABLE_DOWNLOAD_DB_ENCRYPT_V << HP_REG_ENABLE_DOWNLOAD_DB_ENCRYPT_S)
...
#define HP_SYSTEM_REG_ENABLE_DOWNLOAD_G0CB_DECRYPT_M  (HP_REG_ENABLE_DOWNLOAD_G0CB_DECRYPT_V << HP_REG_ENABLE_DOWNLOAD_G0CB_DECRYPT_S)
...
#define HP_SYSTEM_REG_ENABLE_DOWNLOAD_MANUAL_ENCRYPT_M  (HP_REG_ENABLE_DOWNLOAD_MANUAL_ENCRYPT_V << HP_REG_ENABLE_DOWNLOAD_MANUAL_ENCRYPT_S)
...
#define HP_SYSTEM_REG_GPIO_0_HOLD_LOW_M  (HP_REG_GPIO_0_HOLD_LOW_V << HP_REG_GPIO_0_HOLD_LOW_S)
...
#define HP_SYSTEM_REG_GPIO_0_HOLD_HIGH_M  (HP_REG_GPIO_0_HOLD_HIGH_V << HP_REG_GPIO_0_HOLD_HIGH_S)
 ...
 *  NA
 */
#define HP_SYSTEM_SYS_RDN_ECO_CS_REG (DR_REG_HP_SYS_BASE + 0x7c)
/** HP_REG_HP_SYS_RDN_ECO_EN : R/W; bitpos: [0]; default: 0;
 *  NA
 */
#define HP_SYSTEM_REG_HP_SYS_RDN_ECO_EN    (BIT(0))
#define HP_SYSTEM_REG_HP_SYS_RDN_ECO_EN_M  (HP_REG_HP_SYS_RDN_ECO_EN_V << HP_REG_HP_SYS_RDN_ECO_EN_S)
#define HP_SYSTEM_REG_HP_SYS_RDN_ECO_EN_V  0x00000001U
#define HP_SYSTEM_REG_HP_SYS_RDN_ECO_EN_S  0
/** HP_REG_HP_SYS_RDN_ECO_RESULT : RO; bitpos: [1]; default: 0;
 *  NA
 */
#define HP_SYSTEM_REG_HP_SYS_RDN_ECO_RESULT    (BIT(1))
#define HP_SYSTEM_REG_HP_SYS_RDN_ECO_RESULT_M  (HP_REG_HP_SYS_RDN_ECO_RESULT_V << HP_REG_HP_SYS_RDN_ECO_RESULT_S)
#define HP_SYSTEM_REG_HP_SYS_RDN_ECO_RESULT_V  0x00000001U
#define HP_SYSTEM_REG_HP_SYS_RDN_ECO_RESULT_S  1
...
#define HP_SYSTEM_REG_CACHE_APB_POSTW_EN_M  (HP_REG_CACHE_APB_POSTW_EN_V << HP_REG_CACHE_APB_POSTW_EN_S)
...
#define HP_SYSTEM_REG_L2_MEM_SUB_BLKSIZE_M  (HP_REG_L2_MEM_SUB_BLKSIZE_V << HP_REG_L2_MEM_SUB_BLKSIZE_S)
...
#define HP_SYSTEM_REG_L2_MEM_ECC_ERR_INT_RAW_M  (HP_REG_L2_MEM_ECC_ERR_INT_RAW_V << HP_REG_L2_MEM_ECC_ERR_INT_RAW_S)
...
#define HP_SYSTEM_REG_L2_MEM_EXCEED_ADDR_INT_RAW_M  (HP_REG_L2_MEM_EXCEED_ADDR_INT_RAW_V << HP_REG_L2_MEM_EXCEED_ADDR_INT_RAW_S)
...
#define HP_SYSTEM_REG_L2_MEM_ERR_RESP_INT_RAW_M  (HP_REG_L2_MEM_ERR_RESP_INT_RAW_V << HP_REG_L2_MEM_ERR_RESP_INT_RAW_S)
...
#define HP_SYSTEM_REG_L2_MEM_ECC_ERR_INT_ST_M  (HP_REG_L2_MEM_ECC_ERR_INT_ST_V << HP_REG_L2_MEM_ECC_ERR_INT_ST_S)
...
#define HP_SYSTEM_REG_L2_MEM_EXCEED_ADDR_INT_ST_M  (HP_REG_L2_MEM_EXCEED_ADDR_INT_ST_V << HP_REG_L2_MEM_EXCEED_ADDR_INT_ST_S)
...
#define HP_SYSTEM_REG_L2_MEM_ERR_RESP_INT_ST_M  (HP_REG_L2_MEM_ERR_RESP_INT_ST_V << HP_REG_L2_MEM_ERR_RESP_INT_ST_S)
...
#define HP_SYSTEM_REG_L2_MEM_ECC_ERR_INT_ENA_M  (HP_REG_L2_MEM_ECC_ERR_INT_ENA_V << HP_REG_L2_MEM_ECC_ERR_INT_ENA_S)
...
#define HP_SYSTEM_REG_L2_MEM_EXCEED_ADDR_INT_ENA_M  (HP_REG_L2_MEM_EXCEED_ADDR_INT_ENA_V << HP_REG_L2_MEM_EXCEED_ADDR_INT_ENA_S)
...
#define HP_SYSTEM_REG_L2_MEM_ERR_RESP_INT_ENA_M  (HP_REG_L2_MEM_ERR_RESP_INT_ENA_V << HP_REG_L2_MEM_ERR_RESP_INT_ENA_S)
...
#define HP_SYSTEM_REG_L2_MEM_ECC_ERR_INT_CLR_M  (HP_REG_L2_MEM_ECC_ERR_INT_CLR_V << HP_REG_L2_MEM_ECC_ERR_INT_CLR_S)
...
#define HP_SYSTEM_REG_L2_MEM_EXCEED_ADDR_INT_CLR_M  (HP_REG_L2_MEM_EXCEED_ADDR_INT_CLR_V << HP_REG_L2_MEM_EXCEED_ADDR_INT_CLR_S)
...
#define HP_SYSTEM_REG_L2_MEM_ERR_RESP_INT_CLR_M  (HP_REG_L2_MEM_ERR_RESP_INT_CLR_V << HP_REG_L2_MEM_ERR_RESP_INT_CLR_S)
...
#define HP_SYSTEM_REG_L2_RAM_UNIT0_ECC_EN_M  (HP_REG_L2_RAM_UNIT0_ECC_EN_V << HP_REG_L2_RAM_UNIT0_ECC_EN_S)
...
#define HP_SYSTEM_REG_L2_RAM_UNIT1_ECC_EN_M  (HP_REG_L2_RAM_UNIT1_ECC_EN_V << HP_REG_L2_RAM_UNIT1_ECC_EN_S)
...
#define HP_SYSTEM_REG_L2_RAM_UNIT2_ECC_EN_M  (HP_REG_L2_RAM_UNIT2_ECC_EN_V << HP_REG_L2_RAM_UNIT2_ECC_EN_S)
...
#define HP_SYSTEM_REG_L2_RAM_UNIT3_ECC_EN_M  (HP_REG_L2_RAM_UNIT3_ECC_EN_V << HP_REG_L2_RAM_UNIT3_ECC_EN_S)
...
#define HP_SYSTEM_REG_L2_RAM_UNIT4_ECC_EN_M  (HP_REG_L2_RAM_UNIT4_ECC_EN_V << HP_REG_L2_RAM_UNIT4_ECC_EN_S)
...
#define HP_SYSTEM_REG_L2_RAM_UNIT5_ECC_EN_M  (HP_REG_L2_RAM_UNIT5_ECC_EN_V << HP_REG_L2_RAM_UNIT5_ECC_EN_S)
...
#define HP_SYSTEM_REG_L2_MEM_EXCEED_ADDR_INT_ADDR_M  (HP_REG_L2_MEM_EXCEED_ADDR_INT_ADDR_V << HP_REG_L2_MEM_EXCEED_ADDR_INT_ADDR_S)
...
#define HP_SYSTEM_REG_L2_MEM_EXCEED_ADDR_INT_WE_M  (HP_REG_L2_MEM_EXCEED_ADDR_INT_WE_V << HP_REG_L2_MEM_EXCEED_ADDR_INT_WE_S)
...
#define HP_SYSTEM_REG_L2_MEM_EXCEED_ADDR_INT_MASTER_M  (HP_REG_L2_MEM_EXCEED_ADDR_INT_MASTER_V << HP_REG_L2_MEM_EXCEED_ADDR_INT_MASTER_S)
...
#define HP_SYSTEM_REG_L2_MEM_ECC_ERR_INT_ADDR_M  (HP_REG_L2_MEM_ECC_ERR_INT_ADDR_V << HP_REG_L2_MEM_ECC_ERR_INT_ADDR_S)
...
#define HP_SYSTEM_REG_L2_MEM_ECC_ONE_BIT_ERR_M  (HP_REG_L2_MEM_ECC_ONE_BIT_ERR_V << HP_REG_L2_MEM_ECC_ONE_BIT_ERR_S)
...
#define HP_SYSTEM_REG_L2_MEM_ECC_TWO_BIT_ERR_M  (HP_REG_L2_MEM_ECC_TWO_BIT_ERR_V << HP_REG_L2_MEM_ECC_TWO_BIT_ERR_S)
...
#define HP_SYSTEM_REG_L2_MEM_ECC_ERR_BIT_M  (HP_REG_L2_MEM_ECC_ERR_BIT_V << HP_REG_L2_MEM_ECC_ERR_BIT_S)
...
#define HP_SYSTEM_REG_L2_CACHE_ERR_BANK_M  (HP_REG_L2_CACHE_ERR_BANK_V << HP_REG_L2_CACHE_ERR_BANK_S)
...
#define HP_SYSTEM_REG_L2_CACHE_ECC_EN_M  (HP_REG_L2_CACHE_ECC_EN_V << HP_REG_L2_CACHE_ECC_EN_S)
...
#define HP_SYSTEM_REG_L1_CACHE_BUS0_ID_M  (HP_REG_L1_CACHE_BUS0_ID_V << HP_REG_L1_CACHE_BUS0_ID_S)
...
#define HP_SYSTEM_REG_L1_CACHE_BUS1_ID_M  (HP_REG_L1_CACHE_BUS1_ID_V << HP_REG_L1_CACHE_BUS1_ID_S)
...
#define HP_SYSTEM_REG_L2_MEM_RDN_ECO_EN_M  (HP_REG_L2_MEM_RDN_ECO_EN_V << HP_REG_L2_MEM_RDN_ECO_EN_S)
...
#define HP_SYSTEM_REG_L2_MEM_RDN_ECO_RESULT_M  (HP_REG_L2_MEM_RDN_ECO_RESULT_V << HP_REG_L2_MEM_RDN_ECO_RESULT_S)
...
#define HP_SYSTEM_REG_L2_MEM_RDN_ECO_LOW_M  (HP_REG_L2_MEM_RDN_ECO_LOW_V << HP_REG_L2_MEM_RDN_ECO_LOW_S)
...
#define HP_SYSTEM_REG_L2_MEM_RDN_ECO_HIGH_M  (HP_REG_L2_MEM_RDN_ECO_HIGH_V << HP_REG_L2_MEM_RDN_ECO_HIGH_S)
 ...
 *  NA
 */
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_EN    (BIT(0))
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_EN_M  (HP_REG_HP_TCM_RDN_ECO_EN_V << HP_REG_HP_TCM_RDN_ECO_EN_S)
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_EN_V  0x00000001U
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_EN_S  0
/** HP_REG_HP_TCM_RDN_ECO_RESULT : RO; bitpos: [1]; default: 0;
 *  NA
 */
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_RESULT    (BIT(1))
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_RESULT_M  (HP_REG_HP_TCM_RDN_ECO_RESULT_V << HP_REG_HP_TCM_RDN_ECO_RESULT_S)
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_RESULT_V  0x00000001U
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_RESULT_S  1
 ...
 *  NA
 */
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_LOW    0xFFFFFFFFU
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_LOW_M  (HP_REG_HP_TCM_RDN_ECO_LOW_V << HP_REG_HP_TCM_RDN_ECO_LOW_S)
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_LOW_V  0xFFFFFFFFU
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_LOW_S  0
 ...
 *  NA
 */
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_HIGH    0xFFFFFFFFU
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_HIGH_M  (HP_REG_HP_TCM_RDN_ECO_HIGH_V << HP_REG_HP_TCM_RDN_ECO_HIGH_S)
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_HIGH_V  0xFFFFFFFFU
#define HP_SYSTEM_REG_HP_TCM_RDN_ECO_HIGH_S  0
...
#define HP_SYSTEM_REG_GPIO_DED_HOLD_M  (HP_REG_GPIO_DED_HOLD_V << HP_REG_GPIO_DED_HOLD_S)
...
#define HP_SYSTEM_REG_L2_MEM_SW_ECC_BWE_MASK_CTRL_M  (HP_REG_L2_MEM_SW_ECC_BWE_MASK_CTRL_V << HP_REG_L2_MEM_SW_ECC_BWE_MASK_CTRL_S)
...
#define HP_SYSTEM_REG_USB20_MEM_CLK_FORCE_ON_M  (HP_REG_USB20_MEM_CLK_FORCE_ON_V << HP_REG_USB20_MEM_CLK_FORCE_ON_S)
...
#define HP_SYSTEM_TCM_PARITY_ERR_INT_RAW_M  (HP_TCM_PARITY_ERR_INT_RAW_V << HP_TCM_PARITY_ERR_INT_RAW_S)
...
#define HP_SYSTEM_TCM_PARITY_ERR_INT_ST_M  (HP_TCM_PARITY_ERR_INT_ST_V << HP_TCM_PARITY_ERR_INT_ST_S)
...
#define HP_SYSTEM_TCM_PARITY_ERR_INT_ENA_M  (HP_TCM_PARITY_ERR_INT_ENA_V << HP_TCM_PARITY_ERR_INT_ENA_S)
...
#define HP_SYSTEM_TCM_PARITY_ERR_INT_CLR_M  (HP_TCM_PARITY_ERR_INT_CLR_V << HP_TCM_PARITY_ERR_INT_CLR_S)
...
#define HP_SYSTEM_TCM_PARITY_ERR_INT_ADDR_M  (HP_TCM_PARITY_ERR_INT_ADDR_V << HP_TCM_PARITY_ERR_INT_ADDR_S)
...
#define HP_SYSTEM_REG_L1_CACHE_MEM_FO_M  (HP_REG_L1_CACHE_MEM_FO_V << HP_REG_L1_CACHE_MEM_FO_S)
...
#define HP_SYSTEM_REG_L2_CACHE_MEM_FO_M  (HP_REG_L2_CACHE_MEM_FO_V << HP_REG_L2_CACHE_MEM_FO_S)
...
#define HP_SYSTEM_CPU_WAIT_MODE_FORCE_ON_M  (HP_CPU_WAIT_MODE_FORCE_ON_V << HP_CPU_WAIT_MODE_FORCE_ON_S)
...
#define HP_SYSTEM_CPU_WAITI_DELAY_NUM_M  (HP_CPU_WAITI_DELAY_NUM_V << HP_CPU_WAITI_DELAY_NUM_S)
 ...
 */
#define HP_SYSTEM_SYS_CORE_DEBUG_RUNSTALL_CONF_REG (DR_REG_HP_SYS_BASE + 0x11c)
 ...
 */
#define HP_SYSTEM_SYS_CORE_DEBUG_RUNSTALL_ENABLE    (BIT(0))
#define HP_SYSTEM_SYS_CORE_DEBUG_RUNSTALL_ENABLE_M  (HP_SYS_CORE_DEBUG_RUNSTALL_ENABLE_V << HP_SYS_CORE_DEBUG_RUNSTALL_ENABLE_S)
#define HP_SYSTEM_SYS_CORE_DEBUG_RUNSTALL_ENABLE_V  0x00000001U
#define HP_SYSTEM_SYS_CORE_DEBUG_RUNSTALL_ENABLE_S  0
...
#define HP_SYSTEM_CORE_AHB_TIMEOUT_EN_M  (HP_CORE_AHB_TIMEOUT_EN_V << HP_CORE_AHB_TIMEOUT_EN_S)
...
#define HP_SYSTEM_CORE_AHB_TIMEOUT_THRES_M  (HP_CORE_AHB_TIMEOUT_THRES_V << HP_CORE_AHB_TIMEOUT_THRES_S)
...
#define HP_SYSTEM_CORE_IBUS_TIMEOUT_EN_M  (HP_CORE_IBUS_TIMEOUT_EN_V << HP_CORE_IBUS_TIMEOUT_EN_S)
...
#define HP_SYSTEM_CORE_IBUS_TIMEOUT_THRES_M  (HP_CORE_IBUS_TIMEOUT_THRES_V << HP_CORE_IBUS_TIMEOUT_THRES_S)
...
#define HP_SYSTEM_CORE_DBUS_TIMEOUT_EN_M  (HP_CORE_DBUS_TIMEOUT_EN_V << HP_CORE_DBUS_TIMEOUT_EN_S)
...
#define HP_SYSTEM_CORE_DBUS_TIMEOUT_THRES_M  (HP_CORE_DBUS_TIMEOUT_THRES_V << HP_CORE_DBUS_TIMEOUT_THRES_S)
...
#define HP_SYSTEM_CPU_ICM_H2X_POST_WR_EN_M  (HP_CPU_ICM_H2X_POST_WR_EN_V << HP_CPU_ICM_H2X_POST_WR_EN_S)
...
#define HP_SYSTEM_CPU_ICM_H2X_CUT_THROUGH_EN_M  (HP_CPU_ICM_H2X_CUT_THROUGH_EN_V << HP_CPU_ICM_H2X_CUT_THROUGH_EN_S)
...
#define HP_SYSTEM_CPU_ICM_H2X_BRIDGE_BUSY_M  (HP_CPU_ICM_H2X_BRIDGE_BUSY_V << HP_CPU_ICM_H2X_BRIDGE_BUSY_S)
...
#define HP_SYSTEM_PERI1_APB_POSTW_EN_M  (HP_PERI1_APB_POSTW_EN_V << HP_PERI1_APB_POSTW_EN_S)
...
#define HP_SYSTEM_BITSCRAMBLER_PERI_RX_SEL_M  (HP_BITSCRAMBLER_PERI_RX_SEL_V << HP_BITSCRAMBLER_PERI_RX_SEL_S)
...
#define HP_SYSTEM_BITSCRAMBLER_PERI_TX_SEL_M  (HP_BITSCRAMBLER_PERI_TX_SEL_V << HP_BITSCRAMBLER_PERI_TX_SEL_S)
 ...
 *  N/A
 */
#define HP_SYSTEM_SYS_APB_SYNC_POSTW_EN_REG (DR_REG_HP_SYS_BASE + 0x144)
/** HP_SYS_GMAC_APB_POSTW_EN : R/W; bitpos: [0]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_GMAC_APB_POSTW_EN    (BIT(0))
#define HP_SYSTEM_SYS_GMAC_APB_POSTW_EN_M  (HP_SYS_GMAC_APB_POSTW_EN_V << HP_SYS_GMAC_APB_POSTW_EN_S)
#define HP_SYSTEM_SYS_GMAC_APB_POSTW_EN_V  0x00000001U
#define HP_SYSTEM_SYS_GMAC_APB_POSTW_EN_S  0
/** HP_SYS_DSI_HOST_APB_POSTW_EN : R/W; bitpos: [1]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_DSI_HOST_APB_POSTW_EN    (BIT(1))
#define HP_SYSTEM_SYS_DSI_HOST_APB_POSTW_EN_M  (HP_SYS_DSI_HOST_APB_POSTW_EN_V << HP_SYS_DSI_HOST_APB_POSTW_EN_S)
#define HP_SYSTEM_SYS_DSI_HOST_APB_POSTW_EN_V  0x00000001U
#define HP_SYSTEM_SYS_DSI_HOST_APB_POSTW_EN_S  1
/** HP_SYS_CSI_HOST_APB_SYNC_POSTW_EN : R/W; bitpos: [2]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_CSI_HOST_APB_SYNC_POSTW_EN    (BIT(2))
#define HP_SYSTEM_SYS_CSI_HOST_APB_SYNC_POSTW_EN_M  (HP_SYS_CSI_HOST_APB_SYNC_POSTW_EN_V << HP_SYS_CSI_HOST_APB_SYNC_POSTW_EN_S)
#define HP_SYSTEM_SYS_CSI_HOST_APB_SYNC_POSTW_EN_V  0x00000001U
#define HP_SYSTEM_SYS_CSI_HOST_APB_SYNC_POSTW_EN_S  2
/** HP_SYS_CSI_HOST_APB_ASYNC_POSTW_EN : R/W; bitpos: [3]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_CSI_HOST_APB_ASYNC_POSTW_EN    (BIT(3))
#define HP_SYSTEM_SYS_CSI_HOST_APB_ASYNC_POSTW_EN_M  (HP_SYS_CSI_HOST_APB_ASYNC_POSTW_EN_V << HP_SYS_CSI_HOST_APB_ASYNC_POSTW_EN_S)
#define HP_SYSTEM_SYS_CSI_HOST_APB_ASYNC_POSTW_EN_V  0x00000001U
#define HP_SYSTEM_SYS_CSI_HOST_APB_ASYNC_POSTW_EN_S  3

/** HP_SYS_GDMA_CTRL_REG register
 *  N/A
 */
#define HP_SYSTEM_SYS_GDMA_CTRL_REG (DR_REG_HP_SYS_BASE + 0x148)
/** HP_SYS_DEBUG_CH_NUM : R/W; bitpos: [1:0]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_DEBUG_CH_NUM    0x00000003U
#define HP_SYSTEM_SYS_DEBUG_CH_NUM_M  (HP_SYS_DEBUG_CH_NUM_V << HP_SYS_DEBUG_CH_NUM_S)
#define HP_SYSTEM_SYS_DEBUG_CH_NUM_V  0x00000003U
#define HP_SYSTEM_SYS_DEBUG_CH_NUM_S  0

/** HP_SYS_GMAC_CTRL0_REG register
 *  N/A
 */
#define HP_SYSTEM_SYS_GMAC_CTRL0_REG (DR_REG_HP_SYS_BASE + 0x14c)
/** HP_SYS_PTP_PPS : RO; bitpos: [0]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_PTP_PPS    (BIT(0))
#define HP_SYSTEM_SYS_PTP_PPS_M  (HP_SYS_PTP_PPS_V << HP_SYS_PTP_PPS_S)
#define HP_SYSTEM_SYS_PTP_PPS_V  0x00000001U
#define HP_SYSTEM_SYS_PTP_PPS_S  0
/** HP_SYS_SBD_FLOWCTRL : R/W; bitpos: [1]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_SBD_FLOWCTRL    (BIT(1))
#define HP_SYSTEM_SYS_SBD_FLOWCTRL_M  (HP_SYS_SBD_FLOWCTRL_V << HP_SYS_SBD_FLOWCTRL_S)
#define HP_SYSTEM_SYS_SBD_FLOWCTRL_V  0x00000001U
#define HP_SYSTEM_SYS_SBD_FLOWCTRL_S  1
/** HP_SYS_PHY_INTF_SEL : R/W; bitpos: [4:2]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_PHY_INTF_SEL    0x00000007U
#define HP_SYSTEM_SYS_PHY_INTF_SEL_M  (HP_SYS_PHY_INTF_SEL_V << HP_SYS_PHY_INTF_SEL_S)
#define HP_SYSTEM_SYS_PHY_INTF_SEL_V  0x00000007U
#define HP_SYSTEM_SYS_PHY_INTF_SEL_S  2
/** HP_SYS_GMAC_MEM_CLK_FORCE_ON : R/W; bitpos: [5]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_GMAC_MEM_CLK_FORCE_ON    (BIT(5))
#define HP_SYSTEM_SYS_GMAC_MEM_CLK_FORCE_ON_M  (HP_SYS_GMAC_MEM_CLK_FORCE_ON_V << HP_SYS_GMAC_MEM_CLK_FORCE_ON_S)
#define HP_SYSTEM_SYS_GMAC_MEM_CLK_FORCE_ON_V  0x00000001U
#define HP_SYSTEM_SYS_GMAC_MEM_CLK_FORCE_ON_S  5
/** HP_SYS_GMAC_RST_CLK_TX_N : RO; bitpos: [6]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_GMAC_RST_CLK_TX_N    (BIT(6))
#define HP_SYSTEM_SYS_GMAC_RST_CLK_TX_N_M  (HP_SYS_GMAC_RST_CLK_TX_N_V << HP_SYS_GMAC_RST_CLK_TX_N_S)
#define HP_SYSTEM_SYS_GMAC_RST_CLK_TX_N_V  0x00000001U
#define HP_SYSTEM_SYS_GMAC_RST_CLK_TX_N_S  6
/** HP_SYS_GMAC_RST_CLK_RX_N : RO; bitpos: [7]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_GMAC_RST_CLK_RX_N    (BIT(7))
#define HP_SYSTEM_SYS_GMAC_RST_CLK_RX_N_M  (HP_SYS_GMAC_RST_CLK_RX_N_V << HP_SYS_GMAC_RST_CLK_RX_N_S)
#define HP_SYSTEM_SYS_GMAC_RST_CLK_RX_N_V  0x00000001U
#define HP_SYSTEM_SYS_GMAC_RST_CLK_RX_N_S  7

/** HP_SYS_GMAC_CTRL1_REG register
 *  N/A
 */
#define HP_SYSTEM_SYS_GMAC_CTRL1_REG (DR_REG_HP_SYS_BASE + 0x150)
/** HP_SYS_PTP_TIMESTAMP_L : RO; bitpos: [31:0]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_PTP_TIMESTAMP_L    0xFFFFFFFFU
#define HP_SYSTEM_SYS_PTP_TIMESTAMP_L_M  (HP_SYS_PTP_TIMESTAMP_L_V << HP_SYS_PTP_TIMESTAMP_L_S)
#define HP_SYSTEM_SYS_PTP_TIMESTAMP_L_V  0xFFFFFFFFU
#define HP_SYSTEM_SYS_PTP_TIMESTAMP_L_S  0

/** HP_SYS_GMAC_CTRL2_REG register
 *  N/A
 */
#define HP_SYSTEM_SYS_GMAC_CTRL2_REG (DR_REG_HP_SYS_BASE + 0x154)
/** HP_SYS_PTP_TIMESTAMP_H : RO; bitpos: [31:0]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_PTP_TIMESTAMP_H    0xFFFFFFFFU
#define HP_SYSTEM_SYS_PTP_TIMESTAMP_H_M  (HP_SYS_PTP_TIMESTAMP_H_V << HP_SYS_PTP_TIMESTAMP_H_S)
#define HP_SYSTEM_SYS_PTP_TIMESTAMP_H_V  0xFFFFFFFFU
#define HP_SYSTEM_SYS_PTP_TIMESTAMP_H_S  0

/** HP_SYS_VPU_CTRL_REG register
 *  N/A
 */
#define HP_SYSTEM_SYS_VPU_CTRL_REG (DR_REG_HP_SYS_BASE + 0x158)
/** HP_SYS_PPA_LSLP_MEM_PD : R/W; bitpos: [0]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_PPA_LSLP_MEM_PD    (BIT(0))
#define HP_SYSTEM_SYS_PPA_LSLP_MEM_PD_M  (HP_SYS_PPA_LSLP_MEM_PD_V << HP_SYS_PPA_LSLP_MEM_PD_S)
#define HP_SYSTEM_SYS_PPA_LSLP_MEM_PD_V  0x00000001U
#define HP_SYSTEM_SYS_PPA_LSLP_MEM_PD_S  0
/** HP_SYS_JPEG_SDSLP_MEM_PD : R/W; bitpos: [1]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_JPEG_SDSLP_MEM_PD    (BIT(1))
#define HP_SYSTEM_SYS_JPEG_SDSLP_MEM_PD_M  (HP_SYS_JPEG_SDSLP_MEM_PD_V << HP_SYS_JPEG_SDSLP_MEM_PD_S)
#define HP_SYSTEM_SYS_JPEG_SDSLP_MEM_PD_V  0x00000001U
#define HP_SYSTEM_SYS_JPEG_SDSLP_MEM_PD_S  1
/** HP_SYS_JPEG_LSLP_MEM_PD : R/W; bitpos: [2]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_JPEG_LSLP_MEM_PD    (BIT(2))
#define HP_SYSTEM_SYS_JPEG_LSLP_MEM_PD_M  (HP_SYS_JPEG_LSLP_MEM_PD_V << HP_SYS_JPEG_LSLP_MEM_PD_S)
#define HP_SYSTEM_SYS_JPEG_LSLP_MEM_PD_V  0x00000001U
#define HP_SYSTEM_SYS_JPEG_LSLP_MEM_PD_S  2
/** HP_SYS_JPEG_DSLP_MEM_PD : R/W; bitpos: [3]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_JPEG_DSLP_MEM_PD    (BIT(3))
#define HP_SYSTEM_SYS_JPEG_DSLP_MEM_PD_M  (HP_SYS_JPEG_DSLP_MEM_PD_V << HP_SYS_JPEG_DSLP_MEM_PD_S)
#define HP_SYSTEM_SYS_JPEG_DSLP_MEM_PD_V  0x00000001U
#define HP_SYSTEM_SYS_JPEG_DSLP_MEM_PD_S  3
/** HP_SYS_DMA2D_LSLP_MEM_PD : R/W; bitpos: [4]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_DMA2D_LSLP_MEM_PD    (BIT(4))
#define HP_SYSTEM_SYS_DMA2D_LSLP_MEM_PD_M  (HP_SYS_DMA2D_LSLP_MEM_PD_V << HP_SYS_DMA2D_LSLP_MEM_PD_S)
#define HP_SYSTEM_SYS_DMA2D_LSLP_MEM_PD_V  0x00000001U
#define HP_SYSTEM_SYS_DMA2D_LSLP_MEM_PD_S  4

/** HP_SYS_USBOTG20_CTRL_REG register
 *  N/A
 */
#define HP_SYSTEM_SYS_USBOTG20_CTRL_REG (DR_REG_HP_SYS_BASE + 0x15c)
/** HP_SYS_OTG_PHY_TEST_DONE : RO; bitpos: [0]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_OTG_PHY_TEST_DONE    (BIT(0))
#define HP_SYSTEM_SYS_OTG_PHY_TEST_DONE_M  (HP_SYS_OTG_PHY_TEST_DONE_V << HP_SYS_OTG_PHY_TEST_DONE_S)
#define HP_SYSTEM_SYS_OTG_PHY_TEST_DONE_V  0x00000001U
#define HP_SYSTEM_SYS_OTG_PHY_TEST_DONE_S  0
/** HP_SYS_USB_MEM_AUX_CTRL : R/W; bitpos: [14:1]; default: 4896;
 *  N/A
 */
#define HP_SYSTEM_SYS_USB_MEM_AUX_CTRL    0x00003FFFU
#define HP_SYSTEM_SYS_USB_MEM_AUX_CTRL_M  (HP_SYS_USB_MEM_AUX_CTRL_V << HP_SYS_USB_MEM_AUX_CTRL_S)
#define HP_SYSTEM_SYS_USB_MEM_AUX_CTRL_V  0x00003FFFU
#define HP_SYSTEM_SYS_USB_MEM_AUX_CTRL_S  1
/** HP_SYS_PHY_SUSPENDM : R/W; bitpos: [15]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_PHY_SUSPENDM    (BIT(15))
#define HP_SYSTEM_SYS_PHY_SUSPENDM_M  (HP_SYS_PHY_SUSPENDM_V << HP_SYS_PHY_SUSPENDM_S)
#define HP_SYSTEM_SYS_PHY_SUSPENDM_V  0x00000001U
#define HP_SYSTEM_SYS_PHY_SUSPENDM_S  15
/** HP_SYS_PHY_SUSPEND_FORCE_EN : R/W; bitpos: [16]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_PHY_SUSPEND_FORCE_EN    (BIT(16))
#define HP_SYSTEM_SYS_PHY_SUSPEND_FORCE_EN_M  (HP_SYS_PHY_SUSPEND_FORCE_EN_V << HP_SYS_PHY_SUSPEND_FORCE_EN_S)
#define HP_SYSTEM_SYS_PHY_SUSPEND_FORCE_EN_V  0x00000001U
#define HP_SYSTEM_SYS_PHY_SUSPEND_FORCE_EN_S  16
/** HP_SYS_PHY_RSTN : R/W; bitpos: [17]; default: 1;
 *  N/A
 */
#define HP_SYSTEM_SYS_PHY_RSTN    (BIT(17))
#define HP_SYSTEM_SYS_PHY_RSTN_M  (HP_SYS_PHY_RSTN_V << HP_SYS_PHY_RSTN_S)
#define HP_SYSTEM_SYS_PHY_RSTN_V  0x00000001U
#define HP_SYSTEM_SYS_PHY_RSTN_S  17
/** HP_SYS_PHY_RESET_FORCE_EN : R/W; bitpos: [18]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_PHY_RESET_FORCE_EN    (BIT(18))
#define HP_SYSTEM_SYS_PHY_RESET_FORCE_EN_M  (HP_SYS_PHY_RESET_FORCE_EN_V << HP_SYS_PHY_RESET_FORCE_EN_S)
#define HP_SYSTEM_SYS_PHY_RESET_FORCE_EN_V  0x00000001U
#define HP_SYSTEM_SYS_PHY_RESET_FORCE_EN_S  18
/** HP_SYS_PHY_PLL_FORCE_EN : R/W; bitpos: [19]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_PHY_PLL_FORCE_EN    (BIT(19))
#define HP_SYSTEM_SYS_PHY_PLL_FORCE_EN_M  (HP_SYS_PHY_PLL_FORCE_EN_V << HP_SYS_PHY_PLL_FORCE_EN_S)
#define HP_SYSTEM_SYS_PHY_PLL_FORCE_EN_V  0x00000001U
#define HP_SYSTEM_SYS_PHY_PLL_FORCE_EN_S  19
/** HP_SYS_PHY_PLL_EN : R/W; bitpos: [20]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_PHY_PLL_EN    (BIT(20))
#define HP_SYSTEM_SYS_PHY_PLL_EN_M  (HP_SYS_PHY_PLL_EN_V << HP_SYS_PHY_PLL_EN_S)
#define HP_SYSTEM_SYS_PHY_PLL_EN_V  0x00000001U
#define HP_SYSTEM_SYS_PHY_PLL_EN_S  20
/** HP_SYS_OTG_SUSPENDM : R/W; bitpos: [21]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_OTG_SUSPENDM    (BIT(21))
#define HP_SYSTEM_SYS_OTG_SUSPENDM_M  (HP_SYS_OTG_SUSPENDM_V << HP_SYS_OTG_SUSPENDM_S)
#define HP_SYSTEM_SYS_OTG_SUSPENDM_V  0x00000001U
#define HP_SYSTEM_SYS_OTG_SUSPENDM_S  21
/** HP_SYS_OTG_PHY_TXBITSTUFF_EN : R/W; bitpos: [22]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_OTG_PHY_TXBITSTUFF_EN    (BIT(22))
#define HP_SYSTEM_SYS_OTG_PHY_TXBITSTUFF_EN_M  (HP_SYS_OTG_PHY_TXBITSTUFF_EN_V << HP_SYS_OTG_PHY_TXBITSTUFF_EN_S)
#define HP_SYSTEM_SYS_OTG_PHY_TXBITSTUFF_EN_V  0x00000001U
#define HP_SYSTEM_SYS_OTG_PHY_TXBITSTUFF_EN_S  22
/** HP_SYS_OTG_PHY_REFCLK_MODE : R/W; bitpos: [23]; default: 1;
 *  N/A
 */
#define HP_SYSTEM_SYS_OTG_PHY_REFCLK_MODE    (BIT(23))
#define HP_SYSTEM_SYS_OTG_PHY_REFCLK_MODE_M  (HP_SYS_OTG_PHY_REFCLK_MODE_V << HP_SYS_OTG_PHY_REFCLK_MODE_S)
#define HP_SYSTEM_SYS_OTG_PHY_REFCLK_MODE_V  0x00000001U
#define HP_SYSTEM_SYS_OTG_PHY_REFCLK_MODE_S  23
/** HP_SYS_OTG_PHY_BISTEN : R/W; bitpos: [24]; default: 0;
 *  N/A
 */
#define HP_SYSTEM_SYS_OTG_PHY_BISTEN    (BIT(24))
#define HP_SYSTEM_SYS_OTG_PHY_BISTEN_M  (HP_SYS_OTG_PHY_BISTEN_V << HP_SYS_OTG_PHY_BISTEN_S)
#define HP_SYSTEM_SYS_OTG_PHY_BISTEN_V  0x00000001U
#define HP_SYSTEM_SYS_OTG_PHY_BISTEN_S  24
...
#define HP_SYSTEM_TCM_ERR_RESP_EN_M  (HP_TCM_ERR_RESP_EN_V << HP_TCM_ERR_RESP_EN_S)
...
#define HP_SYSTEM_REG_L2_MEM_UNIT0_REFERSH_EN_M  (HP_REG_L2_MEM_UNIT0_REFERSH_EN_V << HP_REG_L2_MEM_UNIT0_REFERSH_EN_S)
...
#define HP_SYSTEM_REG_L2_MEM_UNIT1_REFERSH_EN_M  (HP_REG_L2_MEM_UNIT1_REFERSH_EN_V << HP_REG_L2_MEM_UNIT1_REFERSH_EN_S)
...
#define HP_SYSTEM_REG_L2_MEM_UNIT2_REFERSH_EN_M  (HP_REG_L2_MEM_UNIT2_REFERSH_EN_V << HP_REG_L2_MEM_UNIT2_REFERSH_EN_S)
...
#define HP_SYSTEM_REG_L2_MEM_UNIT3_REFERSH_EN_M  (HP_REG_L2_MEM_UNIT3_REFERSH_EN_V << HP_REG_L2_MEM_UNIT3_REFERSH_EN_S)
...
#define HP_SYSTEM_REG_L2_MEM_UNIT4_REFERSH_EN_M  (HP_REG_L2_MEM_UNIT4_REFERSH_EN_V << HP_REG_L2_MEM_UNIT4_REFERSH_EN_S)
...
#define HP_SYSTEM_REG_L2_MEM_UNIT5_REFERSH_EN_M  (HP_REG_L2_MEM_UNIT5_REFERSH_EN_V << HP_REG_L2_MEM_UNIT5_REFERSH_EN_S)
...
#define HP_SYSTEM_REG_L2_MEM_REFERSH_CNT_RESET_M  (HP_REG_L2_MEM_REFERSH_CNT_RESET_V << HP_REG_L2_MEM_REFERSH_CNT_RESET_S)
...
#define HP_SYSTEM_REG_L2_MEM_UNIT0_REFRESH_DONE_M  (HP_REG_L2_MEM_UNIT0_REFRESH_DONE_V << HP_REG_L2_MEM_UNIT0_REFRESH_DONE_S)
...
#define HP_SYSTEM_REG_L2_MEM_UNIT1_REFRESH_DONE_M  (HP_REG_L2_MEM_UNIT1_REFRESH_DONE_V << HP_REG_L2_MEM_UNIT1_REFRESH_DONE_S)
...
#define HP_SYSTEM_REG_L2_MEM_UNIT2_REFRESH_DONE_M  (HP_REG_L2_MEM_UNIT2_REFRESH_DONE_V << HP_REG_L2_MEM_UNIT2_REFRESH_DONE_S)
...
#define HP_SYSTEM_REG_L2_MEM_UNIT3_REFRESH_DONE_M  (HP_REG_L2_MEM_UNIT3_REFRESH_DONE_V << HP_REG_L2_MEM_UNIT3_REFRESH_DONE_S)
...
#define HP_SYSTEM_REG_L2_MEM_UNIT4_REFRESH_DONE_M  (HP_REG_L2_MEM_UNIT4_REFRESH_DONE_V << HP_REG_L2_MEM_UNIT4_REFRESH_DONE_S)
...
#define HP_SYSTEM_REG_L2_MEM_UNIT5_REFRESH_DONE_M  (HP_REG_L2_MEM_UNIT5_REFRESH_DONE_V << HP_REG_L2_MEM_UNIT5_REFRESH_DONE_S)
...
#define HP_SYSTEM_REG_TCM_INIT_EN_M  (HP_REG_TCM_INIT_EN_V << HP_REG_TCM_INIT_EN_S)
...
#define HP_SYSTEM_REG_TCM_INIT_CNT_RESET_M  (HP_REG_TCM_INIT_CNT_RESET_V << HP_REG_TCM_INIT_CNT_RESET_S)
...
#define HP_SYSTEM_REG_TCM_INIT_DONE_M  (HP_REG_TCM_INIT_DONE_V << HP_REG_TCM_INIT_DONE_S)
...
#define HP_SYSTEM_TCM_PARITY_CHECK_EN_M  (HP_TCM_PARITY_CHECK_EN_V << HP_TCM_PARITY_CHECK_EN_S)
...
#define HP_SYSTEM_DFV0_M  (HP_DFV0_V << HP_DFV0_S)
...
#define HP_SYSTEM_DFV1_M  (HP_DFV1_V << HP_DFV1_S)
...
#define HP_SYSTEM_PSRAM_FLASH_ADDR_INTERCHANGE_CPU_M  (HP_PSRAM_FLASH_ADDR_INTERCHANGE_CPU_V << HP_PSRAM_FLASH_ADDR_INTERCHANGE_CPU_S)
...
#define HP_SYSTEM_PSRAM_FLASH_ADDR_INTERCHANGE_DMA_M  (HP_PSRAM_FLASH_ADDR_INTERCHANGE_DMA_V << HP_PSRAM_FLASH_ADDR_INTERCHANGE_DMA_S)
...
#define HP_SYSTEM_CPU_ICM_H2X_BRESP_ERR_INT_RAW_M  (HP_CPU_ICM_H2X_BRESP_ERR_INT_RAW_V << HP_CPU_ICM_H2X_BRESP_ERR_INT_RAW_S)
...
#define HP_SYSTEM_CPU_ICM_H2X_BRESP_ERR_INT_ST_M  (HP_CPU_ICM_H2X_BRESP_ERR_INT_ST_V << HP_CPU_ICM_H2X_BRESP_ERR_INT_ST_S)
...
#define HP_SYSTEM_CPU_ICM_H2X_BRESP_ERR_INT_ENA_M  (HP_CPU_ICM_H2X_BRESP_ERR_INT_ENA_V << HP_CPU_ICM_H2X_BRESP_ERR_INT_ENA_S)
...
#define HP_SYSTEM_CPU_ICM_H2X_BRESP_ERR_INT_CLR_M  (HP_CPU_ICM_H2X_BRESP_ERR_INT_CLR_V << HP_CPU_ICM_H2X_BRESP_ERR_INT_CLR_S)
...
#define HP_SYSTEM_L2_MEM_ERR_RESP_EN_M  (HP_L2_MEM_ERR_RESP_EN_V << HP_L2_MEM_ERR_RESP_EN_S)
...
#define HP_SYSTEM_L2_MEM_AHB_WRBUFFER_EN_M  (HP_L2_MEM_AHB_WRBUFFER_EN_V << HP_L2_MEM_AHB_WRBUFFER_EN_S)
...
#define HP_SYSTEM_L2_MEM_AHB_RDBUFFER_EN_M  (HP_L2_MEM_AHB_RDBUFFER_EN_V << HP_L2_MEM_AHB_RDBUFFER_EN_S)
...
#define HP_SYSTEM_CORE_DMACTIVE_LPCORE_M  (HP_CORE_DMACTIVE_LPCORE_V << HP_CORE_DMACTIVE_LPCORE_S)
...
#define HP_SYSTEM_CORE_ERR_RESP_DIS_M  (HP_CORE_ERR_RESP_DIS_V << HP_CORE_ERR_RESP_DIS_S)
...
#define HP_SYSTEM_CORE0_AHB_TIMEOUT_INT_RAW_M  (HP_CORE0_AHB_TIMEOUT_INT_RAW_V << HP_CORE0_AHB_TIMEOUT_INT_RAW_S)
...
#define HP_SYSTEM_CORE1_AHB_TIMEOUT_INT_RAW_M  (HP_CORE1_AHB_TIMEOUT_INT_RAW_V << HP_CORE1_AHB_TIMEOUT_INT_RAW_S)
...
#define HP_SYSTEM_CORE0_IBUS_TIMEOUT_INT_RAW_M  (HP_CORE0_IBUS_TIMEOUT_INT_RAW_V << HP_CORE0_IBUS_TIMEOUT_INT_RAW_S)
...
#define HP_SYSTEM_CORE1_IBUS_TIMEOUT_INT_RAW_M  (HP_CORE1_IBUS_TIMEOUT_INT_RAW_V << HP_CORE1_IBUS_TIMEOUT_INT_RAW_S)
...
#define HP_SYSTEM_CORE0_DBUS_TIMEOUT_INT_RAW_M  (HP_CORE0_DBUS_TIMEOUT_INT_RAW_V << HP_CORE0_DBUS_TIMEOUT_INT_RAW_S)
...
#define HP_SYSTEM_CORE1_DBUS_TIMEOUT_INT_RAW_M  (HP_CORE1_DBUS_TIMEOUT_INT_RAW_V << HP_CORE1_DBUS_TIMEOUT_INT_RAW_S)
...
#define HP_SYSTEM_CORE0_AHB_TIMEOUT_INT_ST_M  (HP_CORE0_AHB_TIMEOUT_INT_ST_V << HP_CORE0_AHB_TIMEOUT_INT_ST_S)
...
#define HP_SYSTEM_CORE1_AHB_TIMEOUT_INT_ST_M  (HP_CORE1_AHB_TIMEOUT_INT_ST_V << HP_CORE1_AHB_TIMEOUT_INT_ST_S)
...
#define HP_SYSTEM_CORE0_IBUS_TIMEOUT_INT_ST_M  (HP_CORE0_IBUS_TIMEOUT_INT_ST_V << HP_CORE0_IBUS_TIMEOUT_INT_ST_S)
...
#define HP_SYSTEM_CORE1_IBUS_TIMEOUT_INT_ST_M  (HP_CORE1_IBUS_TIMEOUT_INT_ST_V << HP_CORE1_IBUS_TIMEOUT_INT_ST_S)
...
#define HP_SYSTEM_CORE0_DBUS_TIMEOUT_INT_ST_M  (HP_CORE0_DBUS_TIMEOUT_INT_ST_V << HP_CORE0_DBUS_TIMEOUT_INT_ST_S)
...
#define HP_SYSTEM_CORE1_DBUS_TIMEOUT_INT_ST_M  (HP_CORE1_DBUS_TIMEOUT_INT_ST_V << HP_CORE1_DBUS_TIMEOUT_INT_ST_S)
...
#define HP_SYSTEM_CORE0_AHB_TIMEOUT_INT_ENA_M  (HP_CORE0_AHB_TIMEOUT_INT_ENA_V << HP_CORE0_AHB_TIMEOUT_INT_ENA_S)
...
#define HP_SYSTEM_CORE1_AHB_TIMEOUT_INT_ENA_M  (HP_CORE1_AHB_TIMEOUT_INT_ENA_V << HP_CORE1_AHB_TIMEOUT_INT_ENA_S)
...
#define HP_SYSTEM_CORE0_IBUS_TIMEOUT_INT_ENA_M  (HP_CORE0_IBUS_TIMEOUT_INT_ENA_V << HP_CORE0_IBUS_TIMEOUT_INT_ENA_S)
...
#define HP_SYSTEM_CORE1_IBUS_TIMEOUT_INT_ENA_M  (HP_CORE1_IBUS_TIMEOUT_INT_ENA_V << HP_CORE1_IBUS_TIMEOUT_INT_ENA_S)
...
#define HP_SYSTEM_CORE0_DBUS_TIMEOUT_INT_ENA_M  (HP_CORE0_DBUS_TIMEOUT_INT_ENA_V << HP_CORE0_DBUS_TIMEOUT_INT_ENA_S)
...
#define HP_SYSTEM_CORE1_DBUS_TIMEOUT_INT_ENA_M  (HP_CORE1_DBUS_TIMEOUT_INT_ENA_V << HP_CORE1_DBUS_TIMEOUT_INT_ENA_S)
...
#define HP_SYSTEM_CORE0_AHB_TIMEOUT_INT_CLR_M  (HP_CORE0_AHB_TIMEOUT_INT_CLR_V << HP_CORE0_AHB_TIMEOUT_INT_CLR_S)
...
#define HP_SYSTEM_CORE1_AHB_TIMEOUT_INT_CLR_M  (HP_CORE1_AHB_TIMEOUT_INT_CLR_V << HP_CORE1_AHB_TIMEOUT_INT_CLR_S)
...
#define HP_SYSTEM_CORE0_IBUS_TIMEOUT_INT_CLR_M  (HP_CORE0_IBUS_TIMEOUT_INT_CLR_V << HP_CORE0_IBUS_TIMEOUT_INT_CLR_S)
...
#define HP_SYSTEM_CORE1_IBUS_TIMEOUT_INT_CLR_M  (HP_CORE1_IBUS_TIMEOUT_INT_CLR_V << HP_CORE1_IBUS_TIMEOUT_INT_CLR_S)
...
#define HP_SYSTEM_CORE0_DBUS_TIMEOUT_INT_CLR_M  (HP_CORE0_DBUS_TIMEOUT_INT_CLR_V << HP_CORE0_DBUS_TIMEOUT_INT_CLR_S)
...
#define HP_SYSTEM_CORE1_DBUS_TIMEOUT_INT_CLR_M  (HP_CORE1_DBUS_TIMEOUT_INT_CLR_V << HP_CORE1_DBUS_TIMEOUT_INT_CLR_S)
...
#define HP_SYSTEM_REG_GPIO_0_HYS_LOW_M  (HP_REG_GPIO_0_HYS_LOW_V << HP_REG_GPIO_0_HYS_LOW_S)
...
#define HP_SYSTEM_REG_GPIO_0_HYS_HIGH_M  (HP_REG_GPIO_0_HYS_HIGH_V << HP_REG_GPIO_0_HYS_HIGH_S)
...
#define HP_SYSTEM_RSA_MEM_FORCE_PD_M  (HP_RSA_MEM_FORCE_PD_V << HP_RSA_MEM_FORCE_PD_S)
...
#define HP_SYSTEM_RSA_MEM_FORCE_PU_M  (HP_RSA_MEM_FORCE_PU_V << HP_RSA_MEM_FORCE_PU_S)
...
#define HP_SYSTEM_RSA_MEM_PD_M  (HP_RSA_MEM_PD_V << HP_RSA_MEM_PD_S)
...
#define HP_SYSTEM_ECC_MEM_FORCE_PD_M  (HP_ECC_MEM_FORCE_PD_V << HP_ECC_MEM_FORCE_PD_S)
...
#define HP_SYSTEM_ECC_MEM_FORCE_PU_M  (HP_ECC_MEM_FORCE_PU_V << HP_ECC_MEM_FORCE_PU_S)
...
#define HP_SYSTEM_ECC_MEM_PD_M  (HP_ECC_MEM_PD_V << HP_ECC_MEM_PD_S)
...
#define HP_SYSTEM_RNG_SAMPLE_ENABLE_M  (HP_RNG_SAMPLE_ENABLE_V << HP_RNG_SAMPLE_ENABLE_S)
...
#define HP_SYSTEM_RNG_CHAIN_CLK_DIV_NUM_M  (HP_RNG_CHAIN_CLK_DIV_NUM_V << HP_RNG_CHAIN_CLK_DIV_NUM_S)
...
#define HP_SYSTEM_UART_MEM_FORCE_PD_M  (HP_UART_MEM_FORCE_PD_V << HP_UART_MEM_FORCE_PD_S)
...
#define HP_SYSTEM_UART_MEM_FORCE_PU_M  (HP_UART_MEM_FORCE_PU_V << HP_UART_MEM_FORCE_PU_S)
...
#define HP_SYSTEM_RMT_MEM_CLK_FORCE_ON_M  (HP_RMT_MEM_CLK_FORCE_ON_V << HP_RMT_MEM_CLK_FORCE_ON_S)
...
#define HP_SYSTEM_BITSCRAMBLER_TX_MEM_CLK_FORCE_ON_M  (HP_BITSCRAMBLER_TX_MEM_CLK_FORCE_ON_V << HP_BITSCRAMBLER_TX_MEM_CLK_FORCE_ON_S)
...
#define HP_SYSTEM_BITSCRAMBLER_RX_MEM_CLK_FORCE_ON_M  (HP_BITSCRAMBLER_RX_MEM_CLK_FORCE_ON_V << HP_BITSCRAMBLER_RX_MEM_CLK_FORCE_ON_S)
...
#define HP_SYSTEM_GDMA_MEM_CLK_FORCE_ON_M  (HP_GDMA_MEM_CLK_FORCE_ON_V << HP_GDMA_MEM_CLK_FORCE_ON_S)
#define HP_SYSTEM_GDMA_MEM_CLK_FORCE_ON_V  0x00000001U
#define HP_SYSTEM_GDMA_MEM_CLK_FORCE_ON_S  3

/** HP_USB_OTGHS_PHY_ST_REG register
 *  Usb otg2.0 PHY status register
 */
#define HP_SYSTEM_USB_OTGHS_PHY_ST_REG (DR_REG_HP_SYS_BASE + 0x1e8)
/** HP_USB_SOFT_RESET_ACTV_PDOMAIN : RO; bitpos: [0]; default: 0;
 *  Todo
 */
#define HP_SYSTEM_USB_SOFT_RESET_ACTV_PDOMAIN    (BIT(0))
#define HP_SYSTEM_USB_SOFT_RESET_ACTV_PDOMAIN_M  (HP_USB_SOFT_RESET_ACTV_PDOMAIN_V << HP_USB_SOFT_RESET_ACTV_PDOMAIN_S)
#define HP_SYSTEM_USB_SOFT_RESET_ACTV_PDOMAIN_V  0x00000001U
#define HP_SYSTEM_USB_SOFT_RESET_ACTV_PDOMAIN_S  0
/** HP_UTMISRP_SESSEND : RO; bitpos: [1]; default: 0;
 *  Todo
 */
#define HP_SYSTEM_UTMISRP_SESSEND    (BIT(1))
#define HP_SYSTEM_UTMISRP_SESSEND_M  (HP_UTMISRP_SESSEND_V << HP_UTMISRP_SESSEND_S)
#define HP_SYSTEM_UTMISRP_SESSEND_V  0x00000001U
#define HP_SYSTEM_UTMISRP_SESSEND_S  1
/** HP_UTMIOTG_VBUSVALID : RO; bitpos: [2]; default: 0;
 *  Todo
 */
#define HP_SYSTEM_UTMIOTG_VBUSVALID    (BIT(2))
#define HP_SYSTEM_UTMIOTG_VBUSVALID_M  (HP_UTMIOTG_VBUSVALID_V << HP_UTMIOTG_VBUSVALID_S)
#define HP_SYSTEM_UTMIOTG_VBUSVALID_V  0x00000001U
#define HP_SYSTEM_UTMIOTG_VBUSVALID_S  2
/** HP_UTMISRP_BVALID : RO; bitpos: [3]; default: 0;
 *  Todo
 */
#define HP_SYSTEM_UTMISRP_BVALID    (BIT(3))
#define HP_SYSTEM_UTMISRP_BVALID_M  (HP_UTMISRP_BVALID_V << HP_UTMISRP_BVALID_S)
#define HP_SYSTEM_UTMISRP_BVALID_V  0x00000001U
#define HP_SYSTEM_UTMISRP_BVALID_S  3
/** HP_UTMISRP_SESSVALID : RO; bitpos: [4]; default: 0;
 *  Todo
 */
#define HP_SYSTEM_UTMISRP_SESSVALID    (BIT(4))
#define HP_SYSTEM_UTMISRP_SESSVALID_M  (HP_UTMISRP_SESSVALID_V << HP_UTMISRP_SESSVALID_S)
#define HP_SYSTEM_UTMISRP_SESSVALID_V  0x00000001U
#define HP_SYSTEM_UTMISRP_SESSVALID_S  4

/** HP_CPU_WAKEUP_EVENT_REG register
 *  cpu wakeup event ctrl register
 */
#define HP_SYSTEM_CPU_WAKEUP_EVENT_REG (DR_REG_HP_SYS_BASE + 0x1ec)
/** HP_CORE0_WAKEUP_EVENT : R/W; bitpos: [0]; default: 0;
 *  Set this bit to wake up hp core0
 */
#define HP_SYSTEM_CORE0_WAKEUP_EVENT    (BIT(0))
#define HP_SYSTEM_CORE0_WAKEUP_EVENT_M  (HP_CORE0_WAKEUP_EVENT_V << HP_CORE0_WAKEUP_EVENT_S)
#define HP_SYSTEM_CORE0_WAKEUP_EVENT_V  0x00000001U
#define HP_SYSTEM_CORE0_WAKEUP_EVENT_S  0
/** HP_CORE1_WAKEUP_EVENT : R/W; bitpos: [1]; default: 0;
 *  Set this bit to wake up hp core1
 */
#define HP_SYSTEM_CORE1_WAKEUP_EVENT    (BIT(1))
#define HP_SYSTEM_CORE1_WAKEUP_EVENT_M  (HP_CORE1_WAKEUP_EVENT_V << HP_CORE1_WAKEUP_EVENT_S)
#define HP_SYSTEM_CORE1_WAKEUP_EVENT_V  0x00000001U
#define HP_SYSTEM_CORE1_WAKEUP_EVENT_S  1

/** HP_HP2LP_INTR_GROUP0_EN_REG register
 *  HpP2LP Interrupt Enable Register Group0
 */
#define HP_SYSTEM_HP2LP_INTR_GROUP0_EN_REG (DR_REG_HP_SYS_BASE + 0x1f0)
/** HP_H2LP_INTR_GROUP0_EN : R/W; bitpos: [31:0]; default: 4294967295;
 *  Set each bit to enable corresponding peripheral interrupt to LP CPU.
 */
#define HP_SYSTEM_H2LP_INTR_GROUP0_EN    0xFFFFFFFFU
#define HP_SYSTEM_H2LP_INTR_GROUP0_EN_M  (HP_H2LP_INTR_GROUP0_EN_V << HP_H2LP_INTR_GROUP0_EN_S)
#define HP_SYSTEM_H2LP_INTR_GROUP0_EN_V  0xFFFFFFFFU
#define HP_SYSTEM_H2LP_INTR_GROUP0_EN_S  0

/** HP_HP2LP_INTR_GROUP1_EN_REG register
 *  HpP2LP Interrupt Enable Register Group1
 */
#define HP_SYSTEM_HP2LP_INTR_GROUP1_EN_REG (DR_REG_HP_SYS_BASE + 0x1f4)
/** HP_H2LP_INTR_GROUP1_EN : R/W; bitpos: [31:0]; default: 4294967295;
 *  Set each bit to enable corresponding peripheral interrupt to LP CPU.
 */
#define HP_SYSTEM_H2LP_INTR_GROUP1_EN    0xFFFFFFFFU
#define HP_SYSTEM_H2LP_INTR_GROUP1_EN_M  (HP_H2LP_INTR_GROUP1_EN_V << HP_H2LP_INTR_GROUP1_EN_S)
#define HP_SYSTEM_H2LP_INTR_GROUP1_EN_V  0xFFFFFFFFU
#define HP_SYSTEM_H2LP_INTR_GROUP1_EN_S  0

/** HP_HP2LP_INTR_GROUP2_EN_REG register
 *  HpP2LP Interrupt Enable Register Group2
 */
#define HP_SYSTEM_HP2LP_INTR_GROUP2_EN_REG (DR_REG_HP_SYS_BASE + 0x1f8)
/** HP_H2LP_INTR_GROUP2_EN : R/W; bitpos: [31:0]; default: 4294967295;
 *  Set each bit to enable corresponding peripheral interrupt to LP CPU.
 */
#define HP_SYSTEM_H2LP_INTR_GROUP2_EN    0xFFFFFFFFU
#define HP_SYSTEM_H2LP_INTR_GROUP2_EN_M  (HP_H2LP_INTR_GROUP2_EN_V << HP_H2LP_INTR_GROUP2_EN_S)
#define HP_SYSTEM_H2LP_INTR_GROUP2_EN_V  0xFFFFFFFFU
#define HP_SYSTEM_H2LP_INTR_GROUP2_EN_S  0

/** HP_HP2LP_INTR_GROUP3_EN_REG register
 *  HpP2LP Interrupt Enable Register Group3
 */
#define HP_SYSTEM_HP2LP_INTR_GROUP3_EN_REG (DR_REG_HP_SYS_BASE + 0x1fc)
/** HP_H2LP_INTR_GROUP3_EN : R/W; bitpos: [13:0]; default: 16383;
 *  Set each bit to enable corresponding peripheral interrupt to LP CPU.
 */
#define HP_SYSTEM_H2LP_INTR_GROUP3_EN    0x00003FFFU
#define HP_SYSTEM_H2LP_INTR_GROUP3_EN_M  (HP_H2LP_INTR_GROUP3_EN_V << HP_H2LP_INTR_GROUP3_EN_S)
#define HP_SYSTEM_H2LP_INTR_GROUP3_EN_V  0x00003FFFU
#define HP_SYSTEM_H2LP_INTR_GROUP3_EN_S  0

/** HP_HP2LP_INTR_GROUP0_ST_REG register
 *  HpP2LP Interrupt Status Register Group0
 */
#define HP_SYSTEM_HP2LP_INTR_GROUP0_ST_REG (DR_REG_HP_SYS_BASE + 0x200)
/** HP_H2LP_INTR_GROUP0_ST : RO; bitpos: [31:0]; default: 0;
 *  Each bit indicates the status of corresponding peripheral interrupt to LP CPU.
 */
#define HP_SYSTEM_H2LP_INTR_GROUP0_ST    0xFFFFFFFFU
#define HP_SYSTEM_H2LP_INTR_GROUP0_ST_M  (HP_H2LP_INTR_GROUP0_ST_V << HP_H2LP_INTR_GROUP0_ST_S)
#define HP_SYSTEM_H2LP_INTR_GROUP0_ST_V  0xFFFFFFFFU
#define HP_SYSTEM_H2LP_INTR_GROUP0_ST_S  0

/** HP_HP2LP_INTR_GROUP1_ST_REG register
 *  HpP2LP Interrupt Enable Register Group1
 */
#define HP_SYSTEM_HP2LP_INTR_GROUP1_ST_REG (DR_REG_HP_SYS_BASE + 0x204)
/** HP_H2LP_INTR_GROUP1_ST : RO; bitpos: [31:0]; default: 0;
 *  Each bit indicates the status of corresponding peripheral interrupt to LP CPU.
 */
#define HP_SYSTEM_H2LP_INTR_GROUP1_ST    0xFFFFFFFFU
#define HP_SYSTEM_H2LP_INTR_GROUP1_ST_M  (HP_H2LP_INTR_GROUP1_ST_V << HP_H2LP_INTR_GROUP1_ST_S)
#define HP_SYSTEM_H2LP_INTR_GROUP1_ST_V  0xFFFFFFFFU
#define HP_SYSTEM_H2LP_INTR_GROUP1_ST_S  0

/** HP_HP2LP_INTR_GROUP2_ST_REG register
 *  HpP2LP Interrupt Enable Register Group2
 */
#define HP_SYSTEM_HP2LP_INTR_GROUP2_ST_REG (DR_REG_HP_SYS_BASE + 0x208)
/** HP_H2LP_INTR_GROUP2_ST : RO; bitpos: [31:0]; default: 0;
 *  Each bit indicates the status of corresponding peripheral interrupt to LP CPU.
 */
#define HP_SYSTEM_H2LP_INTR_GROUP2_ST    0xFFFFFFFFU
#define HP_SYSTEM_H2LP_INTR_GROUP2_ST_M  (HP_H2LP_INTR_GROUP2_ST_V << HP_H2LP_INTR_GROUP2_ST_S)
#define HP_SYSTEM_H2LP_INTR_GROUP2_ST_V  0xFFFFFFFFU
#define HP_SYSTEM_H2LP_INTR_GROUP2_ST_S  0

/** HP_HP2LP_INTR_GROUP3_ST_REG register
 *  HpP2LP Interrupt Enable Register Group3
 */
#define HP_SYSTEM_HP2LP_INTR_GROUP3_ST_REG (DR_REG_HP_SYS_BASE + 0x20c)
/** HP_H2LP_INTR_GROUP3_ST : RO; bitpos: [13:0]; default: 0;
 *  Each bit indicates the status of corresponding peripheral interrupt to LP CPU.
 */
#define HP_SYSTEM_H2LP_INTR_GROUP3_ST    0x00003FFFU
#define HP_SYSTEM_H2LP_INTR_GROUP3_ST_M  (HP_H2LP_INTR_GROUP3_ST_V << HP_H2LP_INTR_GROUP3_ST_S)
#define HP_SYSTEM_H2LP_INTR_GROUP3_ST_V  0x00003FFFU
#define HP_SYSTEM_H2LP_INTR_GROUP3_ST_S  0

/** HP_HP2LP_WAKEUP_GROUP0_EN_REG register
 *  HpP2LP Wakeup Enable Register Group0
 */
#define HP_SYSTEM_HP2LP_WAKEUP_GROUP0_EN_REG (DR_REG_HP_SYS_BASE + 0x210)
/** HP_H2LP_WAKEUP_GROUP0_EN : R/W; bitpos: [31:0]; default: 0;
 *  Set each bit to enable corresponding peripheral wakeup to PMU.
 */
#define HP_SYSTEM_H2LP_WAKEUP_GROUP0_EN    0xFFFFFFFFU
#define HP_SYSTEM_H2LP_WAKEUP_GROUP0_EN_M  (HP_H2LP_WAKEUP_GROUP0_EN_V << HP_H2LP_WAKEUP_GROUP0_EN_S)
#define HP_SYSTEM_H2LP_WAKEUP_GROUP0_EN_V  0xFFFFFFFFU
#define HP_SYSTEM_H2LP_WAKEUP_GROUP0_EN_S  0

/** HP_HP2LP_WAKEUP_GROUP1_EN_REG register
 *  HpP2LP Wakeup Enable Register Group1
 */
#define HP_SYSTEM_HP2LP_WAKEUP_GROUP1_EN_REG (DR_REG_HP_SYS_BASE + 0x214)
/** HP_H2LP_WAKEUP_GROUP1_EN : R/W; bitpos: [31:0]; default: 0;
 *  Set each bit to enable corresponding peripheral wakeup to PMU.
 */
#define HP_SYSTEM_H2LP_WAKEUP_GROUP1_EN    0xFFFFFFFFU
#define HP_SYSTEM_H2LP_WAKEUP_GROUP1_EN_M  (HP_H2LP_WAKEUP_GROUP1_EN_V << HP_H2LP_WAKEUP_GROUP1_EN_S)
#define HP_SYSTEM_H2LP_WAKEUP_GROUP1_EN_V  0xFFFFFFFFU
#define HP_SYSTEM_H2LP_WAKEUP_GROUP1_EN_S  0

/** HP_HP2LP_WAKEUP_GROUP2_EN_REG register
 *  HpP2LP Wakeup Enable Register Group2
 */
#define HP_SYSTEM_HP2LP_WAKEUP_GROUP2_EN_REG (DR_REG_HP_SYS_BASE + 0x218)
/** HP_H2LP_WAKEUP_GROUP2_EN : R/W; bitpos: [31:0]; default: 0;
 *  Set each bit to enable corresponding peripheral wakeup to PMU.
 */
#define HP_SYSTEM_H2LP_WAKEUP_GROUP2_EN    0xFFFFFFFFU
#define HP_SYSTEM_H2LP_WAKEUP_GROUP2_EN_M  (HP_H2LP_WAKEUP_GROUP2_EN_V << HP_H2LP_WAKEUP_GROUP2_EN_S)
#define HP_SYSTEM_H2LP_WAKEUP_GROUP2_EN_V  0xFFFFFFFFU
#define HP_SYSTEM_H2LP_WAKEUP_GROUP2_EN_S  0

/** HP_HP2LP_WAKEUP_GROUP3_EN_REG register
 *  HpP2LP Wakeup Enable Register Group3
 */
#define HP_SYSTEM_HP2LP_WAKEUP_GROUP3_EN_REG (DR_REG_HP_SYS_BASE + 0x21c)
/** HP_H2LP_WAKEUP_GROUP3_EN : R/W; bitpos: [13:0]; default: 0;
 *  Set each bit to enable corresponding peripheral wakeup to PMU.
 */
#define HP_SYSTEM_H2LP_WAKEUP_GROUP3_EN    0x00003FFFU
#define HP_SYSTEM_H2LP_WAKEUP_GROUP3_EN_M  (HP_H2LP_WAKEUP_GROUP3_EN_V << HP_H2LP_WAKEUP_GROUP3_EN_S)
#define HP_SYSTEM_H2LP_WAKEUP_GROUP3_EN_V  0x00003FFFU
#define HP_SYSTEM_H2LP_WAKEUP_GROUP3_EN_S  0
