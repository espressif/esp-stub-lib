...
{
    WRITE_PERI_REG(SPI1_MEM_C_W0_REG, 0);
    WRITE_PERI_REG(SPI1_MEM_C_CMD_REG, SPI1_MEM_C_FLASH_RDID);
    while (READ_PERI_REG(SPI1_MEM_C_CMD_REG) != 0)
        ;
    uint32_t rdid = READ_PERI_REG(SPI1_MEM_C_W0_REG) & 0xffffff;
